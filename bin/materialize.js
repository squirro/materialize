    ...
    return this.each(function () {
      ...
      ****************/
      ...
      if (methodName === 'destroy') {
        ...
        var isTogglable = $curr_header.length && (methodName === 'open' && !$curr_header.hasClass('active') || methodName === 'close' && $curr_header.hasClass('active'));
        if (isTogglable) {
  ...
  function getWavesEffectElement(e) {
    ...
    while (target.parentElement !== null) {
      if (!(target instanceof SVGElement) && target.className.indexOf('waves-effect') !== -1) {
        element = target;
        break;
      } else if (target instanceof SVGElement && target.className && target.className.baseVal && target.className.baseVal.indexOf('waves-effect') !== -1) {
        element = target;
        break;
      }
